...
import { idlFactory } from './metabuildcity_frontend.did.js';
export { idlFactory } from './metabuildcity_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_METABUILDCITY_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./metabuildcity_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the metabuildcity_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./metabuildcity_frontend.did.js")._SERVICE>}
 */
export const metabuildcity_frontend = createActor(canisterId);
