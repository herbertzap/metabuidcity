...
import { idlFactory } from './metabuildcity_backend.did.js';
export { idlFactory } from './metabuildcity_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_METABUILDCITY_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./metabuildcity_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the metabuildcity_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./metabuildcity_backend.did.js")._SERVICE>}
 */
export const metabuildcity_backend = createActor(canisterId);
